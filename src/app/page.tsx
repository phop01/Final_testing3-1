    ...
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="flex justify-between items-center px-8 py-4 shadow-md bg-white">
        ...
        <div className="space-x-6">
          ...
          <Link href="/register" className="bg-blue-600 text-white px-3 py-1 rounded-lg hover:bg-blue-700">
            Register
          </Link>
        </div>
      </nav>
      ...
      <section className="flex flex-col items-center justify-center flex-1 text-center bg-gradient-to-r from-blue-100 to-purple-100">
        ...
        <div className="space-x-4">
          ...
          <Link href="/register" className="border border-blue-600 text-blue-600 px-5 py-2 rounded-lg hover:bg-blue-50">
            Register
          </Link>
        </div>
      </section>
      ...
      <section className="py-12 px-8 grid md:grid-cols-3 gap-6">
        <div className="p-6 shadow-lg rounded-xl bg-white hover:shadow-xl">
          ...
          <p className="text-gray-600">Experience blazing fast performance with Next.js.</p>
        </div>
        <div className="p-6 shadow-lg rounded-xl bg-white hover:shadow-xl">
          <h3 className="text-xl font-semibold mb-2">Secure</h3>
          <p className="text-gray-600">Login & Register system secured with modern standards.</p>
        </div>
        <div className="p-6 shadow-lg rounded-xl bg-white hover:shadow-xl">
          <h3 className="text-xl font-semibold mb-2">Scalable</h3>
          <p className="text-gray-600">Easily extend and scale your project in the future.</p>
        </div>
      </section>
